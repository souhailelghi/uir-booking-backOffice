...
const Checklist = () => {
  ...
  const totalCheckboxes = reservation.codeUIRList ? reservation.codeUIRList.length : 0;
    ...
    <div className="max-w-lg mx-auto mt-10 p-6 bg-white rounded-lg shadow-md border border-gray-200">
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-gray-800">{sportNames[reservation.sportId] || "Loading..."}</span>
        </div>
        <div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2 mt-4">
              {allChecked ? (
                <span className="text-green-600 font-semibold">✅ All players checked</span>
              ) : (
